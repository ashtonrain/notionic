const BLOG = {
  title: 'ashtonrainBLOG',
  author: 'ashtonrain',
  email: 'nsmbro@gmail.com',
  link: 'https://zuolan.me',
  newsletter: 'ashtonrainWEEKLY',
  description: 'Everything around me new but my friends',
  ...
  defaultCover: '',
  socialLink: {
    twitter: 'https://twitter.com/ashtonra1n',
    github: 'https://github.com/ashtonrain',
    telegram: 'https://t.me/ashtonrain'
  },
  seo: {
    keywords: ['ashtonrain', 'Blog', 'Notion'],
    googleSiteVerification: '' // Remove the value or replace it with your own google site verification code
  },
  notionPageId: process.env.NOTION_PAGE_ID, // DO NOT CHANGE THIS! Edit .env file!
  notionSpacesId: process.env.NOTION_SPACES_ID, // DO NOT CHANGE THIS! Edit .env file!
  notionAccessToken: process.env.NOTION_ACCESS_TOKEN, // Useful if you prefer not to make your database public
  notionDomain: 'ashtonrain.notion.site',
  telegramToken: process.env.TELEGRAM_TOKEN, // The token of your Telegram bot
  telegramChatId: '756705828', // The chat id of your Telegram bot
  telegramChannelUrl: 'https://t.me/+_OcsOihk0psxZjVl', // The link of your Telegram channel
  telegramChannelName: 'ashtonrainTG', // The name of your Telegram channel
